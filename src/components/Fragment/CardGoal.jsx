...
function CardGoal(props) {
  ...
  // 🔥 TAMBAHKAN INI (DEFINISIKAN VARIABEL)
  const targetAmount = data?.target_amount || data?.targetAmount || 1;
  const presentAmount = data?.present_amount || data?.presentAmount || 0;

  // 🔥 TAMBAHKAN INI (CEK CHART VALUE)
